                ...
                @foreach ($orders as $order)
                    ...
                    <tr class="    ">
                        ...
                        <td x-data="">
                            ...
                            <button id="dropdownDefaultButton-{{$order->id}}" data-dropdown-toggle="dropdown-{{$order->id}}"
                            ...
                            <div id="dropdown-{{$order->id}}"
                                ...
                                <ul class="py-2 text-sm text-gray-700  " aria-labelledby="dropdownDefaultButton-{{$order->id}}">
                                    <li>
                                                ...
                                                <td class="whitespace-nowrap py-4 md:w-[384px]">
                                                    <div class="flex items-center aspect-square w-10 h-10 shrink-0">
                                                        <img class="hidden h-auto w-full max-h-full dark:block"
                                                            ...
                                                            alt="imac image" />
                                                        <div href="#" class="hover:underline mx-2">{{$order->product->name}}
                                                        </div>
                                                    </div>
                                                </td>
