<ul class="space-y-2 font-medium"  >
   ...
   <li x-data="{ dropdown: false }">
     ...
     <ul x-show="dropdown" :class="open ? ' ' : 'sm:invisible'" x-on:mouseleave="dropdown = false"  x-transition class="py-2 space-y-2">
           <li class=" ">
  ...
  <li>
    <a href="{{route('seller.orders.index')}}" class="flex items-center p-2 text-gray-900 rounded-lg  relative hover:bg-gray-100   group">
       <i class="fa-solid fa-basket-shopping text-lg ms-2 me-8  "> </i>
...
<li>
   <a href="{{route('customer.chat.index')}}"  class="flex items-center p-2 text-gray-900 rounded-lg  relative hover:bg-gray-100   group">
