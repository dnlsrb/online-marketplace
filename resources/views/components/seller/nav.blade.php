    ...
    <div class="px-3 py-3 lg:px-5 lg:pl-3">
      <div class="flex items-center justify-between">
        ...
        <div class="flex items-center justify-start rtl:justify-end" >
          ...
          <button x-on:click="open = ! open"   type="button" class="inline-flex items-center p-2 sm:hidden   rounded-lg   hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200     ">
