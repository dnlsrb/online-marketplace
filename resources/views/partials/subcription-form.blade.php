<form class=" ">
  ...
  <div class="p-5 flex flex-wrap border rounded rounded-md border-gray-300  mb-4 md:w-full bg-white">
    ...
    <div class="flex justify-center items-center">
        <h2 class="text-gray-900  text-5xl title-font  font-medium  ">₱{{$subscription->price}}</h2><span class="flex items-end h-full">/{{$subscription->total_months}} months</span>
    </div>
    ...
    <h2 class="text-md sm:text-lg font-medium  bg-gray-100     rounded mb-2">
      ...
      <input type="text" id="name" name="name" class="bg-gray-50 border border-gray-300   text-sm sm:text-lg rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  "   required />

      <label for="type" class="block text-sm sm:text-lg font-medium  mt-3  ">Business Type</label>
      <input type="text" name="type" id="type" class="bg-gray-50 border border-gray-300   text-sm sm:text-lg rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  "  required />
     
      <label for="email" class="block mt-2 text-sm sm:text-lg font-medium    ">Email address</label>
      <input type="email" name="email" id="email" class="bg-gray-50 border border-gray-300   text-sm sm:text-lg rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  " placeholder="john.doe@company.com" required />
      
      <label for="description" class="block  text-sm sm:text-lg font-medium  mt-2 ">Business Description</label>
      <textarea id="description" name="description" rows="4" class="block p-2.5 w-full text-sm sm:text-lg text-gray-900 bg-gray-50 rounded-lg border border-gray-300   " placeholder="Description here"></textarea>
      ...
      <div class="flex items-center justify-center w-full">
        ...
        <label for="dropzone-file" id="label" class="flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50  0">
            <div class="flex flex-col items-center justify-center pt-5 pb-6">
                ...
                <p class="my-2 text-sm sm:text-lg text-gray-500 dark:text-gray-400"><span class="font-semibold">Click to upload</span> or drag and drop</p>
      ...
      <label for="terms" class="ms-2 text-sm sm:text-lg font-medium   dark:text-gray-300">I agree with the <a href="#" class="text-blue-600 hover:underline dark:text-blue-500">terms and conditions</a>.</label>
     </div>
  ...
  <div class=" flex flex-col sm:flex-row justify-between">
    ...
    <a href="{{route('customer.subscriptions.index')}}"  class="  
